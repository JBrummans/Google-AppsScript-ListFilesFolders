...
// Forked from: https://gist.github.com/abubelinha/c797c4b9c5f0da28e351de20ab7f433c
// Upstream from: https://gist.github.com/mesgarpour/07317e81e9ee2b3f1699
...
function onOpen() {
  ...
  function getChildFolders(parentName, parent, data, sheet, listAll) {
    ...
    while (childFolders.hasNext()) {
      ...
      try{
      data.push(childFolder.getOwner().getEmail()) // Not supported with Shared Drives as there is no owner
      } catch {
        data.push("N/A") 
      }
      // Write
      ...
      while (listAll & files.hasNext()) {
        ...
        try{
        data.push(childFile.getOwner().getEmail()) // Not supported with Shared Drives as there is no owner
        } catch {
          data.push("N/A") 
        }
        // Write
